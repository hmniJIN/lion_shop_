...
public class UserController {
    ...
    @PutMapping("/{userId}")
    public ResponseEntity<?> updateUser(@PathVariable long userId, @RequestBody UpdateUserRequestDto updateUserRequestDto){
        UserResponseDto responseDto = userService.updateUser(updateUserRequestDto);
